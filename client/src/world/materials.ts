...
export const MATERIALS: readonly MaterialStyle[] = [
  ...
  { name: 'dirt', look: 'cube', color: 0x7a5534, opacity: 1, textures: all('dirt') },
  ...
  { name: 'ladder_n', look: 'ladder', color: 0xa0703a, opacity: 1, textures: all('ladder') },
  { name: 'ladder_e', look: 'ladder', color: 0xa0703a, opacity: 1, textures: all('ladder') },
  { name: 'ladder_s', look: 'ladder', color: 0xa0703a, opacity: 1, textures: all('ladder') },
  { name: 'ladder_w', look: 'ladder', color: 0xa0703a, opacity: 1, textures: all('ladder') },
