...
| `predict/` **[built]** | Keyboard + pointer-lock input (WASD, Space, Shift, C/Ctrl, F3) and input quantization mirroring the C++ `QuantizeInput`. |
